pro m81dwarf_itime
   ...
   for i=0,n_elements(snr_arr)-1 do begin
       snr = snr_arr[i] 
       itime = cwi_etc_nl_caltime(sff,snr,snr_spatial_bin=spatialbin)    
       itime2 = cwi_etc_nl_caltime(sff,snr,snr_spatial_bin=half_spatialbin)    
   ...
   for i=0,n_elements(snr_arr)-1 do begin
       ...
       itime = cwi_etc_nl_caltime(sff,snr,snr_spatial_bin=spatialbin)
       itime2 = cwi_etc_nl_caltime(sff,snr,snr_spatial_bin=half_spatialbin)
       itime3 = cwi_etc_nl_caltime(sff_central,snr,snr_spatial_bin=half_spatialbin)
