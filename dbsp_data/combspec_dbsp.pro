...
pro combspec::newspec, noredraw=noredraw
...
pro combspec::getspec, list=list, redo=redo
...
pro combspec::initialize_directory, directory=directory,redo=redo
...
function combspec::INIT, directory=directory
    ...
    winditable = widget_table(windibase,value=replicate({id:'',vhelio:-999,sn:-999,exptime:-999},ndup),/row_major,column_labels=['id','vhelio','sn','exptime'],uname='curinditable',uvalue='curinditable')
