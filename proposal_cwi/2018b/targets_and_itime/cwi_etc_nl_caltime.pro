...
function cwi_etc_nl_caltime,flux,snr,snr_spatial_bin=snr_spatial_Bin,halfmoon=halfmoon
common assump, eff,skyflux,lambda,radius
...
;return caltime
    ...
    s = obj_cts_cwi(flux)*snr_spatial_bin*snr_spectral_bin
